...
helper.testSort('quick sort 3 ways', quickSort_1.quickSort3Ways, arr8, n);
...
var nearlyOrderArr4 = JSON.parse(JSON.stringify(nearlyOrderArr));
...
helper.testSort('nearly order quick sort 3 ways', quickSort_1.quickSort3Ways, nearlyOrderArr4, n);
